...
const sendVerificationEmail = async (student) => {
  ...
  const mobileAppLink = `connect2uni://email.verification?token=${token}`;
  ...
  const html = generateEmailTemplate(
    ...
    `
                ...
                <div style="margin: 20px 0; padding: 15px; background-color: #f8f9fa; border-radius: 8px; border-left: 4px solid #004AAC;">
                    <p style="margin: 0; font-size: 14px; color: #666;">
                        <strong>Mobile Users:</strong> If you're using the Connect2Uni mobile app, 
                        the verification will open automatically in the app. If not, you can download it from your app store.
                    </p>
                </div>
`,
    ...
    ` <div style="margin-top: 20px;">
                    ...
                    <div style="margin-top: 15px; padding: 10px; background-color: #e8f4fd; border-radius: 5px; text-align: center;">
                        <p style="margin: 0; font-size: 13px; color: #004AAC;">
                            <strong>Alternative:</strong> 
                            <a href="${mobileAppLink}" style="color: #004AAC; text-decoration: underline;">
                                Open in Connect2Uni App
                            </a>
                        </p>
                    </div>
        </div>
...
// // 🔄 Shared Transporter for Microsoft 365
// const transporter = nodemailer.createTransport({
//   host: "smtp.office365.com",
//   port: 587,
//   secure: false, // TLS
//   auth: {
//     user: process.env.EMAIL_USER, // full Microsoft 365 email
