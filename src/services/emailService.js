...
//miscrosoft graph email service working code 
...
// const clientBaseUrl = process.env.SERVER_URL;

// // --- Azure Credential ---
// const credential = new ClientSecretCredential(tenantId, clientId, clientSecret);

// // --- Generate Email HTML Template (updated styling) ---
// function generateEmailTemplate(title, color, contentHtml, actionButton = null, studentId = null, reminderHtml = null) {
//   const logoCid = "logo@connect2uni";
...
//             <tr>
//               <td style="padding: 20px 30px 0 30px; text-align:center;">
//                 <img src="cid:${logoCid}" alt="Connect2Uni logo" style="margin-bottom: 20px; max-width:160px;" />
//                 <h1 style="margin:0 0 20px 0; color:${color}; font-size:24px; font-weight:600;">${title}</h1>
//               </td>
//             </tr>
...
//                     <div style="margin:30px 0; text-align:center;">
//                       <a href="${actionButton.link}" 
//                         style="background-color:${color}; color:#ffffff; padding:10px 40px; border-radius:5px;
...
//                       ? `
//                     <p style="margin:5px 0; font-size:12px; text-align:center;">
//                       <a href="${clientBaseUrl}/student/unsubscribe/${studentId}" style="color:${color}; text-decoration:underline;">
//                         Unsubscribe from reminders
//                       </a>
//                     </p>`
//                       : ""
...
// // --- Send Email via Direct Graph API REST ---
// async function sendEmail(to, subject, htmlContent) {
//   try {
//     const tokenResponse = await credential.getToken("https://graph.microsoft.com/.default");

//     const recipientEmail = typeof to === "string" ? to : to.email || to.toString();
...
// //   return sendEmail(to, "Let's Get You Started", html);
// // }

// // 📧 Send Verification Email
// // 📧 Send Verification Email via Microsoft Graph
// async function sendVerificationEmail(student) {
...
//       link: verificationLink,
//     },
//     student._id.toString(), // for unsubscribe link if needed
//     `<div style="margin-top: 20px;">
//         <p style="font-weight: 300;">
//           This link will expire in 24 hours, so don't wait too long. If you didn't sign up for Connect2Uni, feel free to ignore this email.
//         </p>
...
//   await sendEmail(student.email, "Let's Get You Started", html);
// }
...
//     "Application Status Update",
//     "#d9534f",
//     `<p style="font-size:16px;color:#333333;line-height:1.6;">Dear ${name},</p>
//      <p style="font-size:16px;color:#555555;line-height:1.6;">After careful consideration, we regret to inform that your application is  
//      <strong style="color:#d9534f;">not approved</strong> at this time. Please login and apply for a different university.</p>
//      <div style="background-color:#f8f9fa;border-left:4px solid #d9534f;padding:15px;border-radius:0 4px 4px 0;margin:20px 0;">
//        <h4 style="margin:0 0 10px 0;color:#d9534f;">Feedback from our team:</h4>
//        <p style="margin:0;color:#555555;">${reason}</p>
//      </div>
...
//   return sendEmail(to, "Your Application Status Update", html);
// }
