...
// const logoPath = path.join(__dirname, '../images/logo.png'); // Adjust path if needed
...
// // 📧 Reset Password Email (Microsoft 365 SMTP)
...
//     secure: false, // TLS
//     auth: {
//       user: process.env.EMAIL_USER, // e.g., yourname@domain.com
//       pass: process.env.EMAIL_PASS  // either normal password or App Password (if MFA enabled)
//     },
//     tls: {
//       ciphers: 'SSLv3'
//     }
...
//         filename: 'logo.png',
//         path: logoPath,
//         cid: 'unique-logo-cid' // matches <img src="cid:unique-logo-cid">
//       }
//     ]
//   });
// };
